...
saveastiff_RGBAsLastDim(results_lt_gt_RGB, [savefolder, '//lt_gt//lt_gt_RGB.tif']);
%%% save fastflim RGB
results_lt_fastflim_RGB = inwlt(results_lt_fastflim, results_in, lt_contrast, in_contrast, cm, flag_white);
saveastiff_RGBAsLastDim(results_lt_fastflim_RGB, [savefolder, '//lt_fastflim//lt_fastflim_RGB.tif']);
